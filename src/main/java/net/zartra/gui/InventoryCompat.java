...
final class InventoryCompat {
 ...
 private static final Set<String> SAFE=new HashSet<String>(Arrays.asList("CHEST","HOPPER","DISPENSER","DROPPER","FURNACE","BLAST_FURNACE","SMOKER","BREWING","WORKBENCH","ENCHANTING","ANVIL","SMITHING","BEACON","SHULKER_BOX","BARREL","LOOM","CARTOGRAPHY","GRINDSTONE","STONECUTTER","LECTERN","MERCHANT","CRAFTER","COMPOSTER","CHISELED_BOOKSHELF","DECORATED_POT"));
